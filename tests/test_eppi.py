...
from app.models.base import AnnotationType, OutputDataType
...
def test_eppi_attribute_creation_from_json_data() -> None:
    ...
    attr_data = {
        ...
        "output_data_type": OutputDataType.BOOLEAN.value,  # Always boolean for EPPI
...
def test_eppi_attribute_with_different_output_types() -> None:
    ...
    assert attr_str.output_data_type.value == OutputDataType.STRING.value

    # Test with int type
    attr_int = EppiAttribute(
        attribute_id="eppi4",
        attribute_label="Integer Attribute",
        output_data_type=OutputDataType.INTEGER,
    )
    assert attr_int.output_data_type.value == OutputDataType.INTEGER.value
...
def test_eppi_gold_standard_annotation_creation_from_json_data() -> None:
    ...
    attr_data = {
        ...
        "AttributeName": "Test EPPI Attribute",
        "question_target": "",
        "output_data_type": OutputDataType.BOOLEAN.value,

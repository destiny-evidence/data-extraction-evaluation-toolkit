...
def test_attribute_creation_with_bool_type() -> None:
...
def test_attribute_creation_with_str_type() -> None:
...
def test_attribute_creation_with_int_type() -> None:
...
def test_attribute_creation_with_list_type() -> None:
...
def test_attribute_creation_with_dict_type() -> None:
...
def test_attribute_creation_with_float_type() -> None:
...
def test_gold_standard_annotation_creation() -> None:
...
def test_gold_standard_annotation_with_llm_type() -> None:

"""
DSPy signatures and extraction pipeline for Obesity RCT outcome data extraction.

Identical pipeline structure to RCTextraction.py but bound to ObesityRCTmodel
classes. Fields are expected to be adapted later for obesity-specific extraction needs.
...
class ObesityRCTExtractionPipeline(dspy.Module):
    """
    Three-step DSPy pipeline for structured Obesity RCT data extraction.
